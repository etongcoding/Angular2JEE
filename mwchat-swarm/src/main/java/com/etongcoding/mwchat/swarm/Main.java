...
import com.etongcoding.mwchat.model.Message;
import com.etongcoding.mwchat.model.Mwchatuser;
import com.etongcoding.mwchat.service.AbstractFacade;
import com.etongcoding.mwchat.service.FriendFacadeREST;
import com.etongcoding.mwchat.service.MessageFacadeREST;
import com.etongcoding.mwchat.service.MwchatuserFacadeREST;
 ...
 * 
 * Test
 * http://localhost:8080/resources/mwchatuser/1
 * http://localhost:8080/resources/friend/2
 * http://localhost:8080/resources/message/1
 */
public class Main {
    public static void main(String...args) throws Exception {
        ...
        // model class 
        deployment.addClass(Friend.class);
        deployment.addClass(Message.class);
        deployment.addClass(Mwchatuser.class);
        // restcalass
        deployment.addClass(AbstractFacade.class);
        deployment.addClass(FriendFacadeREST.class);
        deployment.addClass(MessageFacadeREST.class);
        deployment.addClass(MwchatuserFacadeREST.class);
